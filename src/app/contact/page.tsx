...
const contactMethods = [
  {
    ...
    detail:
      "Send us a message anytime and our team will get back to you within 24 hours.",
  ...
  },
  {
    ...
    detail:
      "Our team is based locally and builds AI tools for creators everywhere.",
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-10">
        <section className="rounded-[2rem] border border-white/[0.08] bg-white/[0.025] p-8 shadow-[0_24px_80px_rgba(0,0,0,0.24)] sm:p-12">
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.25em] text-[#7184ff]">
                Contact
              </p>
              ...
              <p className="mt-6 max-w-2xl font-serif text-lg leading-relaxed text-slate-400">
                Reach out for product support, partnership inquiries, or a
                walkthrough of how PostPilot AI can streamline your content
                process.
              </p>
            </div>
        ...
        <section className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="rounded-[2rem] border border-white/[0.08] bg-white/[0.04] p-8 shadow-[0_24px_80px_rgba(0,0,0,0.24)]">
            <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#7184ff]">
              Need a quick answer?
            </p>
            ...
            <p className="mt-6 max-w-xl font-serif text-lg leading-relaxed text-slate-400">
              If you need help with generating posts, saving drafts, or building
              your brand voice, our support team is here to guide you.
            </p>
            <div className="mt-8 flex flex-wrap gap-4">
              <Link
                href="/features"
                className="inline-flex items-center gap-2 rounded-2xl bg-[#5067f5] px-6 py-3 font-semibold text-white transition hover:bg-[#6278ff]"
              >
                View features <HiArrowRight />
              </Link>
              <Link
                href="/generate-post"
                className="inline-flex items-center gap-2 rounded-2xl border border-white/[0.12] bg-white/[0.05] px-6 py-3 font-semibold text-white transition hover:border-[#7184ff]/40 hover:bg-white/[0.08]"
              >
                Try AI generate
              </Link>
            </div>
            ...
            <ul className="mt-6 space-y-4 text-slate-300">
              <li className="rounded-3xl border border-white/[0.08] bg-[#0f172a]/80 p-5">
                ...
                <p className="mt-2 text-slate-400">
                  Tell us which audience or channel you are targeting so we can
                  tailor AI guidance.
                </p>
              </li>
              <li className="rounded-3xl border border-white/[0.08] bg-[#0f172a]/80 p-5">
                ...
                <p className="mt-2 text-slate-400">
                  If you have brand tone preferences or existing campaigns,
                  mention them for faster help.
                </p>
              </li>
              <li className="rounded-3xl border border-white/[0.08] bg-[#0f172a]/80 p-5">
                <p className="font-semibold text-white">Use the right link</p>
                <p className="mt-2 text-slate-400">
                  If you are asking about saved posts, include the post title or
                  ID so our team can find it quickly.
                </p>
              </li>
            </ul>
          </div>
